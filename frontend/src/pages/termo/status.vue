...
<template>
  <div class="card">
    ...
    <ProgressBar :value="status === 'EmAprovacao' ? 50 : 100" :show-value="false" style="height:15px;" class="mb-3" />
    ...
    <div>
      <div class="grid">
        <div class="text-box col-6">
          ...
          <p v-else :class="status === 'Aprovado' ? 'text-green-500 font-bold' : 'text-red-500 font-bold'">
            {{ status?.toUpperCase() || "" }}
          </p>
        </div>
        <!-- <div class="text-box col-6">
