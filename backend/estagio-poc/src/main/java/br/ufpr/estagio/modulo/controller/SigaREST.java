...
public class SigaREST {
	...
	@GetMapping("/aluno")
	public ResponseEntity<Object> listarAluno(@RequestParam String grr,
	...
	@GetMapping("/docentes")
	public ResponseEntity<Object> listarDocentes(@RequestParam String idPrograma,
			@RequestHeader("Authorization") String accessToken) {
		try {
	...
	@GetMapping("/cursos")
	public ResponseEntity<Object> listarCursos(@RequestParam Long idCurso,
			@RequestHeader("Authorization") String accessToken) {
		try {
			if (idCurso < 1) {
