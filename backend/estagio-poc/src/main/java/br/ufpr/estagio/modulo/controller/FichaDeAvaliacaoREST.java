...
public class FichaDeAvaliacaoREST {
	...
	public ResponseEntity<Object> listarFichasDeAvaliacao() {
		try {
			...
			List<FichaDeAvaliacaoDTO> listaFichasDeAvaliacaoDTO = listaFichasDeAvaliacao.stream()
					.map(ap -> mapper.map(ap, FichaDeAvaliacaoDTO.class)).collect(Collectors.toList());
	...
	public ResponseEntity<Object> buscarFichaDeAvaliacaoPorId(@PathVariable String idFichaDeAvaliacao) {
		try {
			...
			Optional<FichaDeAvaliacao> fichaDeAvaliacao = fichaDeAvaliacaoService
					.buscarFichaDeAvaliacaoPorId(idLongFichaDeAvaliacao);
	...
	public ResponseEntity<Object> atualizarFichaDeAvaliacao(@PathVariable String idFichaDeAvaliacao,
			@RequestBody FichaDeAvaliacaoDTO fichaDeAvaliacaoDTO) {
		try {
			long idLongFichaDeAvaliacao = Long.parseLong(idFichaDeAvaliacao);
			...
			if (fichaDeAvaliacaoDTO.getAtividadesRealizadasConsideracoes() == null
					|| fichaDeAvaliacaoDTO.getAtividadesRealizadasConsideracoes().isEmpty()) {
			...
			if (fichaDeAvaliacaoDTO.getAcompanhamentoOrientadorComentario() == null
					|| fichaDeAvaliacaoDTO.getAcompanhamentoOrientadorComentario().isEmpty()) {
			...
			if (fichaDeAvaliacaoDTO.getAcompanhamentoCoordenadorComentario() == null
					|| fichaDeAvaliacaoDTO.getAcompanhamentoCoordenadorComentario().isEmpty()) {
				throw new InvalidFieldException("Campo 'acompanhamentoCoordenadorComentario' não informado!");
			}

			if (fichaDeAvaliacaoDTO.getContribuicaoEstagio() == null
					|| fichaDeAvaliacaoDTO.getContribuicaoEstagio().isEmpty()) {
			...
			FichaDeAvaliacao fichaDeAvaliacaoAtualizada = fichaDeAvaliacaoService
					.atualizarFichaAvaliacao(fichaDeAvaliacao.get(), fichaDeAvaliacaoDTO);
